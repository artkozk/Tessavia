"""Compare every existing table across migration 043 without printing private rows."""
...
assert tables(after)-tables(before)=={'personal_day_settings','personal_day_focus'}
...
for table in ['personal_day_settings','personal_day_focus']:
...
assert current-previous=={'043_personal_day.sql'} and not previous-current
