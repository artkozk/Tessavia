"""Verify migration 051 without printing or modifying private production rows."""
...
new_tables = {'personal_waiting','personal_waiting_events'}
...
assert current - previous == {'051_personal_waiting.sql'} and not previous - current
