"""Read-only, fail-closed validation for the explicit field-conversion release.
...
if __name__ == '__main__':
    if len(sys.argv) == 3 and sys.argv[1] == '--rollback-safe':
        ...
        raise SystemExit('Usage: verify-field-conversion-database.py BEFORE AFTER | --rollback-safe DB')
