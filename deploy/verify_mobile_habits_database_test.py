...
SCRIPT = ROOT / 'deploy/verify-mobile-habits-database.py'
SPEC = importlib.util.spec_from_file_location('mobile_habits_verifier', SCRIPT)
...
class UnchangedDatabaseTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.fixtures = tempfile.TemporaryDirectory(prefix='tessavia-mobile-habits-verifier-')
