...
export function createNoteLibraryUI({state,api,escapeHTML:esc,icon,renderNoteCard,renderPersonal,loadPersonal,openPersonalEditor,localISODate,openModal,closeDialog,enhanceSelects,bindDraft,clearDraft,flushDrafts,openArchive,askChoice,toast}){
  ...
  function bind(){
    ...
    q('[data-note-archive]',root).onclick=openArchive;
