...
[[ "$RELEASE_NAME" =~ ^20260903-record-pages-[a-f0-9]+$ ]]
...
dry=$(mktemp -d /tmp/tessavie-record-pages-check.XXXXXX)
...
check_http() {
  ...
  grep -q '20260903-record-pages-1' "$dry/index.html"
