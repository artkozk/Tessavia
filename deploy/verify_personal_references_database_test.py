...
SCRIPT = ROOT / 'deploy/verify-personal-references-database.py'
SPEC = importlib.util.spec_from_file_location('personal_references_verifier', SCRIPT)
...
class UnchangedDatabaseTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.fixtures = tempfile.TemporaryDirectory(prefix='tessavia-personal-references-verifier-')
