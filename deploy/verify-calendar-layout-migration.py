"""Verify the frontend-only calendar release preserves all production schemas and rows.
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise SystemExit("Usage: verify-calendar-layout-migration.py BEFORE AFTER")
    verify(*sys.argv[1:])
