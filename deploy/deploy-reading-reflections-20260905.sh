...
check_http() {
  ...
  grep -qF '20260904-reading-reflections-1' "$dry/index.html"
  grep -qF '<title>Tessavie</title>' "$dry/index.html"
  curl --max-time 15 -fsS "$base/reading.js?v=20260904-reading-reflections-1" > "$dry/reading.js"
  ...
  grep -qF 'tessavie-shell-20260904-reading-reflections-1' "$dry/sw.js"
