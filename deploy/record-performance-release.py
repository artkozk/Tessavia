...
try:
    ...
    evidence+='Go test/vet, существующие и новые Node-тесты, браузерные сценарии с длинным текстом и восстановлением черновика, резервная копия, сравнение таблиц и публичная проверка gzip/HTTP2 прошли. '
