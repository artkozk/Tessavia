...
SCRIPT = ROOT / 'deploy/verify-component-recovery-database.py'
SPEC = importlib.util.spec_from_file_location('component_recovery_verifier', SCRIPT)
...
class UnchangedDatabaseTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.fixtures = tempfile.TemporaryDirectory(prefix='tessavia-component-recovery-verifier-')
