...
func (s *Server) registerWorkspaceFinanceRoutes() {
	for pattern, handler := range map[string]http.HandlerFunc{
		...
		"POST /api/workspace/finance/receipts":                s.handleWorkspaceReceipt,
		"GET /api/workspace/finance/receipts/{id}":            s.handleReadWorkspaceReceipt,
		"PUT /api/workspace/finance/receipts/{id}":            s.handleWorkspaceReceipt,
