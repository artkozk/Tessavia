...
[[ "$RELEASE_NAME" =~ ^20260903-classic-brand-[a-f0-9]+$ ]]
...
dry=$(mktemp -d /tmp/tessavie-classic-check.XXXXXX)
...
check_http() {
  ...
  grep -q '20260903-classic-brand-1' "$dry/index.html"
