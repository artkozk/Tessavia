...
check_http() {
  ...
  grep -qF 'app.js?v=20260907-today-capacity-4' "$dry/index.html"
  grep -qF 'styles.css?v=20260907-today-capacity-4' "$dry/index.html"
  curl --max-time 15 -fsS "$base/app.js?v=20260907-today-capacity-4" > "$dry/app.js"
  grep -qF 'chat-workspace.js?v=20260907-today-capacity-4' "$dry/app.js"
  grep -qF 'data-chat-outbox' "$dry/app.js"
  grep -qF 'data-planner-journal' "$dry/app.js"
  curl --max-time 15 -fsS "$base/chat-workspace.js?v=20260907-today-capacity-4" > "$dry/chat.js"
  grep -qF 'createChatWorkspaceUI' "$dry/chat.js"
  curl --max-time 15 -fsS "$base/chat-groups.js?v=20260907-today-capacity-4" > "$dry/groups.js"
  grep -qF 'createChatGroupUI' "$dry/groups.js"
  curl --max-time 15 -fsS "$base/personal-calendar.js?v=20260907-today-capacity-4" > "$dry/calendar.js"
  grep -qF 'openRecurrence' "$dry/calendar.js"
  grep -qF 'bindPersonalRecurrenceScope' "$dry/app.js"
  curl --max-time 15 -fsS "$base/personal-today.js?v=20260907-today-capacity-4" > "$dry/today.js"
  ...
  curl --max-time 15 -fsS "$base/styles.css?v=20260907-today-capacity-4" > "$dry/styles.css"
  grep -qF -- '--chat-menu-left' "$dry/styles.css"
  curl --max-time 15 -fsS "$base/sw.js" > "$dry/sw.js"
  grep -qF 'tessavie-shell-20260907-today-capacity-4' "$dry/sw.js"
