import { createChatGroupUI } from './chat-groups.js?v=20260907-chat-attachments-2';
import { filterConversations, conversationTimeLabel, pendingConversationItems, chatDraftKey, chooseConversation, readConversationDraft, writeConversationDraft, mergeChatHistory, createChatWorkspaceUI } from './chat-workspace.js?v=20260907-chat-attachments-2';
import { createPersonalCalendarUI } from './personal-calendar.js?v=20260907-chat-attachments-2';
import { createPersonalReviewUI } from './personal-review.js?v=20260904-personal-review-3';
import { createPersonalWaitingUI } from './personal-waiting.js?v=20260907-chat-attachments-2';
import { createHabitReminderUI } from './habit-reminders.js?v=20260904-habit-reminders-1';
import { createPersonalRemindersUI } from './personal-reminders.js?v=20260907-chat-attachments-2';
import { createReminderSettingsUI } from './reminder-settings.js?v=20260904-reminder-digests-1';
import { personalRoute } from './personal-navigation.js?v=20260907-chat-attachments-2';
import { createPersonalTodayUI, useProgressiveToday } from './personal-today.js?v=20260907-chat-attachments-2';
...
import { createOutboxUI } from './outbox-ui.js?v=20260907-chat-attachments-2';
let offlineOutbox;
