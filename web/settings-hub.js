...
export function settingsHubSections(context = {}) {
  ...
  const groups = {
    ...
    personal: [
      ...
      row('mobile-access', 'На телефоне', 'Установка приложения, быстрый доступ к заметкам и ярлыки.', 'smartphone'),
      row('reminders', 'Уведомления и напоминания', 'Когда и о чём напоминать лично вам.', 'bell'),
      row('finance', 'Финансы', 'От кого приходит доход, счета и правила распределения.', 'fileText'),
