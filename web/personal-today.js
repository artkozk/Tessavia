...
export function createPersonalTodayUI({state,api,escapeHTML:esc,icon,renderPersonal,renderPlanRow,formatMinutes,openPlan,openProject,togglePlan,openDay,openModal,closeDialog,bindDraft,clearDraft,flushDrafts,toast}){
