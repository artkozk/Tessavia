"""Read-only, fail-closed validation for the application-only mobile/habits release.
...
if __name__ == '__main__':
    if len(sys.argv) == 3 and sys.argv[1] == '--rollback-safe':
        ...
        raise SystemExit('Usage: verify-mobile-habits-database.py BEFORE AFTER | --rollback-safe DB')
