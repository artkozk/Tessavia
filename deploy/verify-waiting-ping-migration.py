"""Verify migration 053 without printing or modifying private production rows."""
...
new_tables = {'personal_waiting_pings'}
...
assert current - previous == {'053_personal_waiting_pings.sql'} and not previous - current
