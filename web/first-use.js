export function helpContext(view, tab, personalWorkspace) {
  ...
  const topics={
    work:['Работайте с очередью','Выберите доску и нужное состояние. Карточка хранит следующий шаг, материалы и результат. Через «Поля и этапы» можно настроить процесс, а через меню карточки — связи и родителя.'],
