...
check_http() {
  ...
  grep -qF 'app.js?v=20260907-chat-forward-2' "$dry/index.html"
  grep -qF 'styles.css?v=20260907-chat-forward-2' "$dry/index.html"
  curl --max-time 15 -fsS "$base/app.js?v=20260907-chat-forward-2" > "$dry/app.js"
  grep -qF 'chat-workspace.js?v=20260907-chat-forward-2' "$dry/app.js"
  grep -qF 'data-chat-history-newer' "$dry/app.js"
  grep -qF 'data-planner-journal' "$dry/app.js"
  curl --max-time 15 -fsS "$base/chat-workspace.js?v=20260907-chat-forward-2" > "$dry/chat.js"
  grep -qF 'createChatWorkspaceUI' "$dry/chat.js"
  curl --max-time 15 -fsS "$base/personal-today.js?v=20260907-chat-forward-2" > "$dry/today.js"
  grep -qF 'todayHiddenBlocks' "$dry/today.js"
  grep -qF 'today-empty-block' "$dry/app.js"
  curl --max-time 15 -fsS "$base/styles.css?v=20260907-chat-forward-2" > "$dry/styles.css"
  grep -qF -- '--chat-menu-left' "$dry/styles.css"
  curl --max-time 15 -fsS "$base/sw.js" > "$dry/sw.js"
  grep -qF 'tessavie-shell-20260907-chat-forward-2' "$dry/sw.js"
