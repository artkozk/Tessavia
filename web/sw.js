const CACHE = 'tessavie-shell-20260907-chat-personal-pins-2';
const ASSETS = [
  '/chat-groups.js?v=20260907-chat-personal-pins-2',
  '/personal-calendar.js?v=20260907-chat-personal-pins-2',
  '/', '/chat-workspace.js?v=20260907-chat-personal-pins-2', '/personal-review.js?v=20260904-personal-review-3', '/personal-waiting.js?v=20260907-chat-personal-pins-2', '/habit-reminders.js?v=20260904-habit-reminders-1', '/app.js?v=20260907-chat-personal-pins-2', '/styles.css?v=20260907-chat-personal-pins-2',
  '/reminder-settings.js?v=20260904-reminder-digests-1',
  '/personal-reminders.js?v=20260907-chat-personal-pins-2',
  '/personal-navigation.js?v=20260907-chat-personal-pins-2',
  '/personal-today.js?v=20260907-chat-personal-pins-2',
  ...
  '/outbox-ui.js?v=20260907-chat-personal-pins-2', '/offline-outbox.js?v=20260903-offline-outbox-3',
